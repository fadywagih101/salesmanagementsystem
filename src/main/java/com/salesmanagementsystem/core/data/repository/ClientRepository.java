...
public interface ClientRepository extends JpaRepository<Client, Long> {
    ...
    @Query("SELECT c, SUM(t.product.price * t.quantity) AS totalSpending FROM Sale s JOIN s.transactions t JOIN s.client c GROUP BY c ORDER BY totalSpending DESC")
